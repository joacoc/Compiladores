...
public class AnalizadorLexico {
	...
	public static final int S_DISTINTO = 280;


	
	static final String warningI = "Warning: Identificador truncado por superar 20 carácteres.";
	...
	//Por ejemplo, un ID se identifica con el 257, CTEI 258...
	...
	//Una vez que reconosco el tipo de token, lo vacio y vuelvo a empezar.
	...
	public AnalizadorLexico( ControladorArchivo archivo, TablaSimbolos ts ) {
		...
		//Estado actual. El estado inicial es siempre 0.
		estadoActual = 0;
		//Almacena el token se esta formando
	...
	public void agregarTokens(){
		...
		//id_tokens.put(5, );
		//id_tokens.put(7, );
		//id_tokens.put(8, value);
		id_tokens.put(14, COMENTARIO);	//COMENTARIO VACIO
		id_tokens.put(15, ANOTACIONF);
		id_tokens.put(16, ANOTACIONC);
		id_tokens.put(17, COMENTARIO);
		id_tokens.put(21, CTEI);
		id_tokens.put(22, CTEL);
		//id_tokens.put(21, value); Caso especial
	}
